...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL200 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -fclkop 200 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL200 is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  3, CLKFB_DIV=>  8, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL200 is
    for Structure
