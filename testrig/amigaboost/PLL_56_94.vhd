...
-- Module  Version: 5.7
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n PLL_56_94 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 41 -trims 0 -phases 0 -trims_r -bdiv 9 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_56_94 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "56.944444";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  8, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  40, 
        ...
        CLKOS_DIV=>  9, CLKOP_DIV=>  41, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_56_94 is
    for Structure
