...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_21_375 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 80.0 -fclkop 21.375 -fclkop_tol 5.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
entity PLL_21_375 is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic);
end PLL_21_375;

architecture Structure of PLL_21_375 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "21.818182";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  23, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  24, CLKFB_DIV=>  3, CLKI_DIV=>  11, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_21_375 is
    for Structure
