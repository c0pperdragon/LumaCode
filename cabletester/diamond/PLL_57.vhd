...
-- Module  Version: 5.7
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n PLL_57 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 55 -trims 0 -phases 0 -trims_r -bdiv 12 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_57 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "57.291667";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  11, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  54, 
        ...
        CLKOS_DIV=>  12, CLKOP_DIV=>  55, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_57 is
    for Structure
