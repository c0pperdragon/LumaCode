...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_16 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 26 -trims 0 -phases 0 -trims_r -bdiv 20 -phase_cntl STATIC -fb_mode 1 

-- Tue Nov 04 12:38:53 2025
...
architecture Structure of PLL_16 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "16.250000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  19, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  25, 
        ...
        CLKOS_DIV=>  20, CLKOP_DIV=>  26, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
