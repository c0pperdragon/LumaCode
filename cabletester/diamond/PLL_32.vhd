...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_32 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 64 -trims 0 -phases 0 -trims_r -bdiv 25 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_32 is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  24, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  63, 
        ...
        CLKOS_DIV=>  25, CLKOP_DIV=>  64, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_32 is
    for Structure
