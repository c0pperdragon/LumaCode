...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_28 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 55 -trims 0 -phases 0 -trims_r -bdiv 24 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_28 is
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_28 is
    for Structure
