...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_14 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25 -mdiv 2 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 63 -trims 0 -phases 0 -trims_r -bdiv 55 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_14 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "14.318182";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  54, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  62, 
        ...
        CLKOS_DIV=>  55, CLKOP_DIV=>  63, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_14 is
    for Structure
